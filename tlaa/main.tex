...
We modify the approach of Kaposi and
Kovács to use the contexts of a domain-specific type theory to generate the signatures
...
\item[How to define the initial algebra] Assuming algebras over these transformed
contexts, we generate an algebra over the original inductive-inductive context of
which we are confident that we will be able to show its initiality.
\end{description}
